                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="https://via.placeholder.com/60" alt="دستبند کارتیه" class="pro-img">
                            </td>
                            <td>
                                <div style="font-weight: 600;">دستبند استیل کارتیه پهن</div>
                            </td>
                            <td><span class="badge-cat">دستبند</span></td>
                            <td>برند 1</td>
                            <td>
                                <span class="pro-color-indicator" style="background: #f59e0b;"></span>
                                طلایی
                            </td>
                            <td style="font-weight: 700;">۸۸۰,۰۰۰</td>
                            <td><span class="stock-badge stock-low">۲ عدد</span></td>
                            <td>
                                <div class="rating-box">
                                    <i class="bi bi-star-fill"></i>
                                    <span>5.0</span>
                            ...
                            <td style="color: var(--text-muted); font-size: 0.8rem;">1403/06/20</td>
                            <td>
                                <button type="button" class="btn-action info" 
                                        onclick="showDetails('دستبند استیل کارتیه پهن', 'استیل ۳۱۶ با بالاترین درجه کیفیت، قفل ضامنی بسیار محکم و ضدآب.')" 
                                        title="مشاهده توضیحات">
                                    <i class="bi bi-card-text"></i>
                                </button>
                            </td>
                            <td>
                                <div style="display: flex; gap: 6px;">
                                    <a href="EditPro.php?id=102" class="btn-action edit" title="ویرایش محصول">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a href="javascript:void(0)" onclick="confirmDelete(102)" class="btn-action delete" title="حذف محصول">
                                        <i class="bi bi-trash"></i>
                                    </a>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="https://via.placeholder.com/60" alt="گردنبند مروارید" class="pro-img">
                            </td>
                            <td>
                                <div style="font-weight: 600;">گردنبند باروک مروارید طبیعی</div>
                            </td>
                            <td><span class="badge-cat">گردنبند</span></td>
                            <td>برند 8</td>
                            <td>
                                <span class="pro-color-indicator" style="background: #ffffff;"></span>
                                سفید صدفی
                            </td>
                            <td style="font-weight: 700;">۱,۲۵۰,۰۰۰</td>
                            <td><span class="stock-badge stock-out">ناموجود</span></td>
                            <td>
                                <div class="rating-box">
                                    <i class="bi bi-star-fill"></i>
                                    <span>4.2</span>
                            ...
                            <td style="color: var(--text-muted); font-size: 0.8rem;">1403/06/15</td>
                            <td>
                                <button type="button" class="btn-action info" 
                                        onclick="showDetails('گردنبند مروارید باروک', 'مروارید پرورشی طبیعی با قفل T طلایی از جنس مس و لعاب طلا.')" 
                                        title="مشاهده توضیحات">
                                    <i class="bi bi-card-text"></i>
                                </button>
                            </td>
                            <td>
                                <div style="display: flex; gap: 6px;">
                                    <a href="EditPro.php?id=103" class="btn-action edit" title="ویرایش محصول">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a href="javascript:void(0)" onclick="confirmDelete(103)" class="btn-action delete" title="حذف محصول">
                                        <i class="bi bi-trash"></i>
                                    </a>
                                </div>
                            </td>
